...
config.OCEAN.DATASET.MIX = edict()
...
config.OCEAN.DATASET.MIX.DIST = 'beta'
config.OCEAN.DATASET.MIX.ALPHA = 1.0
config.OCEAN.DATASET.MIX.BETA = 1.0
config.OCEAN.DATASET.MIX.MIN = 0
config.OCEAN.DATASET.MIX.MAX = 1
config.OCEAN.DATASET.MIX.PROB = 1
...
# train
config.OCEAN.TRAIN.SCRATCH = False
config.OCEAN.TRAIN.EMA = 0.9998
config.OCEAN.TRAIN.NEG_WEIGHT = 0.1
...
config.OCEAN.TRAIN.FREEZE_LAYER = []
# reid
config.OCEAN.REID.PATCH_SIZE = 64
config.OCEAN.REID.SAMPLE_PER_BATCH = 256
config.OCEAN.REID.SAMPLE_PER_EPOCH = 4000
# test
